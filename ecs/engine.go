...
func (engine *Engine) SetEntityList(entityList EntityList) {
	...
	found := engine.Entities.GetEntities(constants.Position)
	for _, f := range found {
...
func (entity *Entity) ReplaceComponent(newComponent Component) *Entity {
	entity.RemoveComponent(newComponent.ComponentType())
	entity.AddComponent(newComponent)
	return entity
}

func (entity *Entity) ReplaceComponents(newComponents ...Component) *Entity {
